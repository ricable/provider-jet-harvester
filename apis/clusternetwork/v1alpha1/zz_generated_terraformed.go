...
func (mg *Clusternetwork) GetTerraformResourceType() string {
	return "harvester_clusternetwork"
}
...
func (tr *Clusternetwork) GetObservation() (map[string]interface{}, error) {
...
func (tr *Clusternetwork) SetObservation(obs map[string]interface{}) error {
...
func (tr *Clusternetwork) GetParameters() (map[string]interface{}, error) {
...
func (tr *Clusternetwork) SetParameters(params map[string]interface{}) error {
